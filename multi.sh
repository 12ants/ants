...
read -n1 -ep "$(tput setaf 7 bold)
  --  Are these changes correct? $(tput setaf 7)[Y$(tput dim)/$(tput sgr0)n$(tput setaf 7)]$(tput setaf 7 bold) " yn;
if [ "$yn" != "${yn#[Nn]}" ]; then
reset; source multi;
else
## write to file
